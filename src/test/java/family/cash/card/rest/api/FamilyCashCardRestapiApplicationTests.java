...
//@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_EACH_TEST_METHOD) //causing Spring to start with a clean slate, as if those other tests hadn't been run
class FamilyCashCardRestapiApplicationTests {
    @Autowired//it’s best used in tests only
